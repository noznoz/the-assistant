...
export function maybeSeed() {
  ...
  db.insert('accessories', { vehicleId: vAlmas.id, name: 'Ceramic window tint', group: 'protection', cost: 2800, shipping: 0, install: 400, installedBy: 'XPEL Riyadh', date: d(-60), status: 'fitted', fitted: true, note: 'Full body, 70% front' })
  db.insert('accessories', { vehicleId: vAlmas.id, name: 'Dash cam (front + rear)', group: 'accessory', cost: 1200, shipping: 120, install: 250, installedBy: 'Sound Studio', website: 'https://www.thinkware.com', date: d(-30), status: 'fitted', fitted: true })
  db.insert('accessories', { vehicleId: vRaven.id, name: 'Touratech panniers', group: 'gears', cost: 6500, shipping: 800, install: 0, installedBy: 'Self', website: 'https://touratech.com', date: d(-45), status: 'fitted', fitted: true, note: 'Aluminium, 38L pair' })
  db.insert('accessories', { vehicleId: vAlmas.id, name: 'Roof cross bars', group: 'gears', cost: 3400, shipping: 300, install: 0, date: todayISO(), status: 'wishlist', fitted: false, note: 'For the Genesis roof box' })
  db.insert('accessories', { vehicleId: vRaven.id, name: 'Akrapovič exhaust', group: 'performance', cost: 9800, shipping: 1500, install: 600, date: todayISO(), status: 'wishlist', fitted: false, website: 'https://www.akrapovic.com' })
  ...
  const vaultVehInsurance = db.insert('vaults', { name: 'Insurance', icon: 'shield', parentId: vaultVehicles.id })
  ...
  db.insert('documents', { title: 'Insurance policy', category: 'insurance', vaultId: vaultVehInsurance.id, vehicleId: vAlmas.id, expiry: d(38), attachments: [] })
