...
export function maybeSeed() {
  ...
  const mSara = db.insert('members', { name: 'Sara Khan', title: 'Coordinator', departmentId: opsDept.id, mobile: '+966500000032', whatsapp: '+966500000032', reportsToId: mFaisal.id })
  db.insert('members', { name: 'Yousef Ali', title: 'Field Officer', departmentId: opsDept.id, mobile: '+966500000034', reportsToId: mSara.id })
