...
export const STRINGS = {
  en: {
    ...
    itemCost: 'Item cost', shippingCost: 'Shipping', installationCost: 'Installation', installedBy: 'Installed by', installedByPlaceholder: 'Workshop / person', purchasedBy: 'Purchased by', purchasedByPlaceholder: 'Shop / person', quantity: 'Quantity', sortNewest: 'Newest first', sortOldest: 'Oldest first', website: 'Website', total: 'Total',
  ...
  ar: {
    ...
    itemCost: 'سعر القطعة', shippingCost: 'الشحن', installationCost: 'التركيب', installedBy: 'رُكّب بواسطة', installedByPlaceholder: 'ورشة / شخص', purchasedBy: 'اشتُري بواسطة', purchasedByPlaceholder: 'متجر / شخص', quantity: 'الكمية', sortNewest: 'الأحدث أولاً', sortOldest: 'الأقدم أولاً', website: 'الموقع', total: 'الإجمالي',
