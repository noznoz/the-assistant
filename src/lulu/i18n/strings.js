...
export const STRINGS = {
  en: {
    ...
    // family / auth
    authJoinTitle: 'Join your family', authJoinSub: 'Create your account to get started.',
    welcomeBack: 'Welcome back', authSignInSub: 'Sign in to your account.', authCreateSub: 'Create your account.',
    authToggleCreate: "Don't have an account? Create one", authToggleSignIn: 'Already have an account? Sign in',
    authNeedProject: 'Add the project connection to continue.', authConnHint: 'Ask the family admin for these if you have them.', authAdvanced: 'Advanced: connection settings',
    inviteMember: 'Invite family member', inviteHint: 'Pick a contact and send them a WhatsApp invite. On iPhone, choose the chat in WhatsApp.',
    inviteMsg: "You're invited to join our family on The Assistant. Tap to join: {link}\n\nOr open the app and enter this household code: {code}",
    memberHello: 'Hi', familyMember: 'Family member', myTasks: 'My tasks', myProfile: 'My profile',
    memberTasksNone: 'Nothing assigned', memberTasksNoneHint: 'Tasks assigned to you will appear here.',
    editProfile: 'Edit profile', reopen: 'Reopen',
    ...
    editReminder: 'Edit reminder', addAnotherTime: 'Add another time', moreTimes: 'more', snooze: 'Snooze', setFor: 'Set for',
    ...
    homeStyle: 'Home style', homeClassic: 'Classic', homeFocus: 'Focus', cards: 'Cards',
    homeStyleHint: 'Classic shows every card. Focus leads with one “Right now” list of what needs you, then your cards.',
    rightNow: 'Right now', allCaughtUp: 'You’re all caught up', allCaughtUpHint: 'Nothing needs you right now.', next: 'Next',
    ...
    searchTeamMember: 'Type a name to find…', saveAndNotify: 'Save & notify on WhatsApp',
  ...
  ar: {
    ...
    // family / auth
    authJoinTitle: 'انضم إلى عائلتك', authJoinSub: 'أنشئ حسابك للبدء.',
    welcomeBack: 'مرحباً بعودتك', authSignInSub: 'سجّل الدخول إلى حسابك.', authCreateSub: 'أنشئ حسابك.',
    authToggleCreate: 'ليس لديك حساب؟ أنشئ حساباً', authToggleSignIn: 'لديك حساب؟ سجّل الدخول',
    authNeedProject: 'أضف إعدادات الاتصال للمتابعة.', authConnHint: 'اطلبها من مسؤول العائلة إن توفّرت لديك.', authAdvanced: 'متقدّم: إعدادات الاتصال',
    inviteMember: 'دعوة فرد من العائلة', inviteHint: 'اختر جهة اتصال وأرسل لها دعوة عبر واتساب. على الآيفون، اختر المحادثة في واتساب.',
    inviteMsg: 'أنت مدعوّ للانضمام إلى عائلتنا على The Assistant. اضغط للانضمام: {link}\n\nأو افتح التطبيق وأدخل رمز العائلة: {code}',
    memberHello: 'مرحباً', familyMember: 'فرد من العائلة', myTasks: 'مهامي', myProfile: 'ملفي',
    memberTasksNone: 'لا مهام مُسندة', memberTasksNoneHint: 'ستظهر المهام المُسندة إليك هنا.',
    editProfile: 'تعديل الملف', reopen: 'إعادة فتح',
    ...
    editReminder: 'تعديل التذكير', addAnotherTime: 'إضافة وقت آخر', moreTimes: 'أخرى', snooze: 'تأجيل', setFor: 'الضبط لـ',
    ...
    homeStyle: 'نمط الرئيسية', homeClassic: 'كلاسيكي', homeFocus: 'التركيز', cards: 'البطاقات',
    homeStyleHint: 'الكلاسيكي يعرض كل البطاقات. التركيز يبدأ بقائمة «الآن» بما يحتاج انتباهك ثم بطاقاتك.',
    rightNow: 'الآن', allCaughtUp: 'أنجزت كل شيء', allCaughtUpHint: 'لا شيء يحتاج انتباهك الآن.', next: 'التالي',
    ...
    searchTeamMember: 'اكتب اسمًا للبحث…', saveAndNotify: 'حفظ وإشعار عبر واتساب',
