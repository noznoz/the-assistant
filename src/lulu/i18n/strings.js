...
export const STRINGS = {
  en: {
    ...
    homeStyleHint: 'Classic shows every card. Focus, Cover, Timeline and Bento are calmer, more focused layouts — pick what fits your day.',
    homeCover: 'Cover', homeTimeline: 'Timeline', homeBento: 'Bento',
    colorScheme: 'Color scheme', colorSchemeHint: 'Recolors the accent across the whole app — buttons, highlights, the calendar tile and the glow.',
    accent_amber: 'Amber', accent_emerald: 'Emerald', accent_sapphire: 'Sapphire', accent_rose: 'Rose', accent_violet: 'Violet', accent_graphite: 'Graphite',
    coverOneThing: 'One thing matters today:', coverAgendaItems: 'things on today’s agenda.', coverClear: 'Your day is clear.',
    laterToday: 'Later today', now: 'NOW', dayOpen: 'Your day is open — a good window to plan ahead.',
    tasksLabel: 'Tasks', nextUp: 'Next up', needsYou: 'Needs you', waitingShort: 'waiting', spentToday: 'Spent today', ofLabel: 'of', due: 'due',
  ...
  ar: {
    ...
    homeStyleHint: 'الكلاسيكي يعرض كل البطاقات. التركيز والغلاف والجدول والشبكة تخطيطات أهدأ وأكثر تركيزًا — اختر ما يناسب يومك.',
    homeCover: 'الغلاف', homeTimeline: 'الجدول الزمني', homeBento: 'الشبكة',
    colorScheme: 'نظام الألوان', colorSchemeHint: 'يغيّر لون التمييز في كامل التطبيق — الأزرار والإبرازات وبطاقة التاريخ والتوهّج.',
    accent_amber: 'كهرماني', accent_emerald: 'زمرّدي', accent_sapphire: 'ياقوتي', accent_rose: 'وردي', accent_violet: 'بنفسجي', accent_graphite: 'رمادي',
    coverOneThing: 'أهم شيء اليوم:', coverAgendaItems: 'مهام على جدول اليوم.', coverClear: 'يومك صافٍ.',
    laterToday: 'لاحقًا اليوم', now: 'الآن', dayOpen: 'يومك مفتوح — فرصة جيدة للتخطيط.',
    tasksLabel: 'المهام', nextUp: 'التالي', needsYou: 'يحتاج انتباهك', waitingShort: 'بالانتظار', spentToday: 'صُرف اليوم', ofLabel: 'من', due: 'مستحقة',
